...
<body>
    ...
    <div class="appHeader">
        ...
        <div class="pageTitle">Lifestyle</div>
        <div class="right">
        </div>
    </div>
    <!-- * App Header -->
                ...
                <div class="splide__track">
                    <ul class="splide__list">
                        ...
                        <li class="splide__slide">
                            <a href="" data-bs-toggle="modal" data-bs-target="#DialogIconedDanger">
                                <div class="card">
                                    <img src="assets/img/sample/photo/movie-tickets.jpg" class="card-img-top" alt="image">
                                    <div class="card-body">
                                        <h5 class="card-title">Movie Tickets</h5>
                                        <p class="card-text" style="color:#fff;">
                                            It's super easy to buy movie tickets from our platform. Never miss blockbusters again
                                        </p>
                                    </div>
                                </div>
                            </a>
                        ...
                        <li class="splide__slide">
                            <a href="" data-bs-toggle="modal" data-bs-target="#DialogIconedDanger">
                                <div class="card" style="color:#fff;">
                                    <img src="assets/img/sample/photo/breaking-news.jpg" class="card-img-top" alt="image">
                                    <div class="card-body">
                                        <h5 class="card-title">Breaking News</h5>
                                        <p class="card-text">
                                            Stay in touch with daily happenings around the world
                                        </p>
                                    </div>
                                </div>
                            </a>
                        ...
                        <li class="splide__slide">
                            <a href="" data-bs-toggle="modal" data-bs-target="#DialogIconedDanger">
                                <div class="card" style="color:#fff;">
                                    <a href="#" >
                                        <img src="assets/img/sample/photo/flight-booking.jpg" class="card-img-top" alt="image">
                                    </a>
                                    <div class="card-body">
                                        <h5 class="card-title">Flight Booking</h5>
                                        <p class="card-text">
                                            With Alat flight booking is easy peasy
                                        </p>
                                    </div>
                                </div>
                            </a>
