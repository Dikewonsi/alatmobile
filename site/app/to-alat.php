...
<body>
            ...
            $result = $conn->query($sql);
                if ($result->num_rows == 0) {
                   ?>
                    ...
                    header('location:Alat-transfer-details.php');
                }                
        }
    ?>
    ...
    <div class="appHeader">
        ...
        <div class="pageTitle">To Alat Account</div>
        <div class="right">
        </div>
    </div>
    <!-- * App Header -->
                    ...
                    <form method="POST" action="<?php echo $_SERVER['PHP_SELF'];?>">
                        ...
                        <div class="form-group basic animated">
                            <div class="input-wrapper">
                                ...
                                <textarea type="text" class="form-control" name="narration" placeholder="Enter Narration" required></textarea>
                                <i class="clear-input">
                                    <ion-icon name="close-circle"></ion-icon>
                                </i>
                            </div>
