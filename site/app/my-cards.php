...
<head>
    ...
    <title>Alat - Card Services</title>
...
<body>
    ...
    <div class="appHeader">
        ...
        <div class="pageTitle">Card Services</div>
        <div class="right">
        </div>
    </div>
    <!-- * App Header -->
    ...
    <div id="appCapsule">              
        ...
        <div class="section mt-2">
            <div class="card">
                <ul class="listview flush transparent image-listview">
                    ...
                    <li>
                        <a href="#" class="item" data-bs-toggle="modal" data-bs-target="#DialogIconedDanger1">
                            <div class="icon-box bg-primary">
                                <i class="material-icons">credit_card</i>
                            </div>
                            <div class="in">
                    ...
                    <li>
                        <a href="card-request.php" class="item">
                            <div class="icon-box bg-primary">
                                <i class="material-icons">credit_card</i>
                            </div>
                            <div class="in">
                    ...
                    <li>
                        <a href="#" class="item" data-bs-toggle="modal" data-bs-target="#DialogIconedDanger3">
                            <div class="icon-box bg-primary">
                                <i class="material-icons">credit_card</i>
                            </div>
                            <div class="in">
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        No Credit card attached to this customer
                    </div>
        ...
        <!-- DialogIconedDanger -->
        <div class="modal fade dialogbox" id="DialogIconedDanger1" data-bs-backdrop="static" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-icon text-danger">
                        <ion-icon name="close-circle"></ion-icon>
                    ...
                    <div class="modal-body">
                        No Debit card attached to this customer
                    </div>
                    <div class="modal-footer">
                        <div class="btn-inline">
                            <a href="#" class="btn" data-bs-dismiss="modal">CLOSE</a>
        ...
        <!-- DialogIconedDanger -->
        <div class="modal fade dialogbox" id="DialogIconedDanger3" data-bs-backdrop="static" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-icon text-danger">
                        <ion-icon name="close-circle"></ion-icon>
                    ...
                    <div class="modal-body">
                        No Virtual card attached to this customer
                    </div>
                    <div class="modal-footer">
                        <div class="btn-inline">
                            <a href="#" class="btn" data-bs-dismiss="modal">CLOSE</a>
