...
<body>
    ...
    <div class="appHeader">
        ...
        <div class="pageTitle">Stop Cheque</div>
        <div class="right">
        </div>
    </div>
    <!-- * App Header -->
    ...
    <div id="appCapsule">
        ...
        <div class="section mt-2">
            <div class="section-title">Please enter document number, security number, and reason</div>
            <div class="card">
                <div class="card-body">
                    <form>
                        ...
                        <div class="form-group basic animated">
                            <div class="input-wrapper">
                                ...
                                <input type="number" class="form-control" placeholder="Security Number">
                                <i class="clear-input">
                                    <ion-icon name="close-circle"></ion-icon>
                                </i>
                            </div>
                        ...
                        <div class="form-group basic animated">
                            <div class="input-wrapper">
                                ...
                                <textarea type="text" class="form-control" placeholder="Reason"></textarea>
                                <i class="clear-input">
                                    <ion-icon name="close-circle"></ion-icon>
                                </i>
                            </div>
                    ...
                    <a type="button" class="btn btn-danger btn-block" data-bs-toggle="modal" data-bs-target="#actionSheetAlertSuccess">STOP</a>
                                ...
                                <div class="modal-body">
                                    <div class="action-sheet-content">
                                        ...
                                        <div class="text-center p-2">
                                            <h3>Success</h3>
                                            <p>Your cheque has been placed on hold or stopped.</p>
                                        </div>
