<?php 
    ...
    while ($rows=mysqli_fetch_assoc($result)){
        ...
        //Save variables in sessions 
        $_SESSION['receiver_name'] = $receiver_name;
        $_SESSION['my_acc_num'] = $my_acc_num;
...
<head> 
    ...
    <title>Alat - Transfer To Others Account</title>
...
<body class="bg-white">
    ...
    if ($fetch_pass !== $pin) {
        ...
        <?php
            ...
            header('location:others-transfer-verification.php');
        }
    ...
    <div id="appCapsule" class="full-height">
        ...
        <div class="section mt-2 mb-2">
            ...
            <ul class="listview flush transparent simple-listview no-space mt-3">
                <li>
                    <strong>From:</strong>
                    <span><?php echo $acc_type; ?> Account <span class="text-success"><?php echo $my_acc_num; ?></span></span>
                </li>
                <li>
                    <strong>To</strong>                    
                    <span><?php echo $_SESSION['acc_name']; ?></span>
                </li>
                <li>
                ...
                <li>
                    ...
                    <span><?php echo $_SESSION['acc_num']; ?></span>
                </li>
                <li>
                    <strong>SWIFT CODE</strong>
                    <span><?php echo $_SESSION['swift_code']; ?></span>
                </li>
                <li>
                    <strong>Date</strong>
